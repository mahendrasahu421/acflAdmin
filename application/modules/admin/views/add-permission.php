        ...
        <div class="block-header py-lg-4 py-3">
            <div class="row g-3">
                <div class="col-md-6 col-sm-12">
                    <h2 class="m-0 fs-5"><a href="javascript:void(0);" class="btn btn-sm btn-link ps-0 btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a> Permissions</h2>
                ...
                <div class="col-md-6 col-sm-12 text-md-end">
                    <div class="d-inline-flex text-start">
                        <div class="me-2">
                            <a href="permissions-list" class="btn btn-primary mt-3">Permissions List</a>
        ...
        <div class="row g-3">
            <div class="col-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="https://vms.cry.in/insert_permission_master" method="post" id="form" name="pForm" onsubmit=" return validate();" enctype="multipart/form-data" class="needs-validation" novalidate>
                            <div class="form-row">
