            ...
            <div class="row g-3">
                ...
                <div class="col-md-6 col-sm-12 text-md-end">
                    <div class="d-inline-flex text-start">
                        <div class="me-2">
                            <a href="brand-Wise-Convency-Setting-list" class="btn btn-primary mt-3">Brand Wise Convency Setting list</a>
            ...
            <div class="col-6">
                <div class="card">
                    <div class="card-header">
                        <h6 class="card-title">Brand Wise Convency Setting</h6>
                    </div>
                    <div class="card-body">
