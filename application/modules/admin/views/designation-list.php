            ...
            <div class="row g-3">
                ...
                <div class="col-md-6 col-sm-12 text-md-end">
                    <div class="d-inline-flex text-start">
                        <div class="me-2">
                            <a href="session-master" class="btn btn-primary mt-3">Designation List</a>
                    ...
                    <table id="myTable" class="table display dataTable table-hover" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="#" onClick="javascript:if(confirm('Do You Want to Edit Desination ?')){return true;}else{return false}">
