        ...
        <div class="block-header py-lg-4 py-3">
            <div class="row g-3">
                <div class="col-md-6 col-sm-12">
                    <h2 class="m-0 fs-5"><a href="javascript:void(0);" class="btn btn-sm btn-link ps-0 btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a> Group Master</h2>
                    <ul class="breadcrumb mb-0">
                        <li class=""><a href="">Home</a>&nbsp;/&nbsp;</li>
                        <li class="breadcrumb-item">Group Master</li>
                ...
                <div class="col-md-6 col-sm-12 text-md-end">
                    <div class="d-inline-flex text-start">
                        <div class="me-2">
                            <a href="<?php echo base_url('group-list')?>" class="btn btn-primary mt-3">Menu List</a>
                    ...
                    <div class="card-body">
                        <form action="insert_menu_master" method="post" id="form" name="pForm" onsubmit=" return validate();" enctype="multipart/form-data" class="needs-validation" novalidate="">
                            <div class="form-row">
                                ...
                                <div class="col-md-12 mb-3">
                                    <label for="validationCustom04" class="form-label">Group Name</label>
                                    <input type="text" name="menu_description" class="form-control select2" id="validationCustom04" value="" placeholder="Group Name " required="">
                                    <div class="invalid-feedback">Select Menu Name</div>
                                </div>
                                <div class="col-md-12 mb-3">
                                    <label for="validationCustom02" class="form-label"> Designation</label>
                                    <input type="text" name="menu_route_name" class="form-control select2" id="validationCustom04" value="" placeholder="Designation" required="">
                                    <div class="invalid-feedback"> Select Menu Name</div>
                                </div>
