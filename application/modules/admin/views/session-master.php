            ...
            <div class="row g-3">
                ...
                <div class="col-md-6 col-sm-12 text-md-end">
                    <div class="d-inline-flex text-start">
                        <div class="me-2">
                            <a href="session-master-list" class="btn btn-primary mt-3">Session List</a>
            ...
            <div class="col-6">
                <div class="card">
                    <div class="card-header">
                        <h6 class="card-title">Session Master</h6>
                    </div>
                    <div class="card-body">
                        <form action="insert_menu_master" method="post" id="form" name="pForm" onsubmit=" return validate();" enctype="multipart/form-data" class="needs-validation" novalidate="">
                            <div class="form-row">
                                <div class="col-md-12 mb-3">
                                    <label for="validationCustom04" class="form-label">Session From</label>
                                ...
                                <div class="col-md-12 mb-3">
                                    <label for="validationCustom02" class="form-label">Session To</label>
                                    <select class="form-control ">
                                        <option value="0">----Select----Year----</option>
                                        <option value="1">2020</option>
                                        <option value="2">2021</option>
